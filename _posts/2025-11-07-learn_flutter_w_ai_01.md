...
> 我是一个对 iOS 开发完全没有经验的 Java Python 软件工程师。如果我想快速开发一个 iOS 应用，我应该怎么开始，用什么样的开发语言和框架？
...
之后，它把两条路的优缺点、可能的坑、学习曲线都列了一遍，并且站在“快速出成果”的角度首推 `Flutter`。这个阶段的信息收集，以前至少要花半小时在各种博客和教学视频里，现在几分钟就把决策完成了。
...
它给了一个很清晰的五段式结构，我后续基本会照着这个清单来推进：
...
每段它都给了关键词和建议时长。虽然我不会严格卡这个时间，但有这个估算，对自己安排学习时间还是帮助不少。
